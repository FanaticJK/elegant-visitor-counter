...
class elegant_visitor_counter_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->elegant_visitor_counter, plugin_dir_url( __FILE__ ) . 'css/plugin-name-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->elegant_visitor_counter, plugin_dir_url( __FILE__ ) . 'js/plugin-name-admin.js', array( 'jquery' ), $this->version, false );
